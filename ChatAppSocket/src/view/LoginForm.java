...
public class LoginForm extends javax.swing.JFrame {
     ...
     */
    public LoginForm(ObjectOutputStream oos, ObjectInputStream ois) throws IOException {
...
//                }
        try {
            ...
            System.out.println(o.getListGroup().size());
            (new HomeForm(socketOfClient, o)).setVisible(true);
            this.dispose();
        } catch (IOException ex) {
            Logger.getLogger(LoginForm.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
